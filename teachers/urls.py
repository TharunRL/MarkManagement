...
from .views import *
urlpatterns = [
    path('department/add/',AddDeptView.as_view(),name='dept_add'),
    path('teacher/add/',AddTeacherView.as_view(),name='teach_add'),
    path('class/add/',AddClassView.as_view(),name='class_add'),
    path('student/add/',AddStudentView.as_view(),name='stud_add'),
    path('',manage,name='manage'),
    path('department/',DeptView.as_view(),name='dept'),
    ...
    path('student/',StudView.as_view(),name='stud'),
    ...
    path('teacher/', TeachView.as_view(), name='teach'),
